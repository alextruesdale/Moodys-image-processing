...
class xmlTableZoneExpander(object):
    ...
    def __init__(self, page, page_data, columns, output_directory_data, zone_list, page_zone_data):
        ...
        self.column_zones = self.identify_table_column()
    ...
    def identify_table_column(self):
        ...
        return (column_id, working_zones)
    ...
    def exclude_titles(self):
        ...
        working_zones = [zone for zone in self.working_zones if
                         ...
                         or abs(zone[2] - zone[4]) >= column_width - .004 or zone is self.zone_list]
