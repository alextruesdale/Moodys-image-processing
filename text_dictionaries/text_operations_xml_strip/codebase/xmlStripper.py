...
class xmlStripper(object):
    ...
    def __init__(self, file_path, working_file):
        ...
        self.page_data_dictionary = self.collect_words()
    ...
    def collect_words(self):
        ...
        for source_data in self.source_dictionary[1000:1400]:
        # for source_data in self.source_dictionary[45:100]:
        # for source_data in self.source_dictionary[1100:1350]:
        # for source_data in self.source_dictionary[1100:1104]:
        # for source_data in self.source_dictionary[1270:1273]:
            file_name = source_data[0][:-4]
            page_data_dictionary.update({file_name: [source_data[1][2], []]})
