...
def final_directories():
    ...
    if not os.path.exists(output_directory):
        ...
        remove_output = output_directory + '/'
        shutil.rmtree(output_directory)
        os.mkdir(output_directory)

def read_me():
    """Copy README.txt file from codebase library to ouput directory"""

    # Define README.txt origin path
    readme = '/scratch/summit/diga9728/alex/codebase/production/README.txt'
    os.system('cp {} .'.format(readme))
