    ...
    def column_crop_operate(self, test_value):
        ...
        for image_array in loop_list:
            ...
            cutpoints_initial = ImageColumnCropOperators.find_cutpoints(
                                image_array, (self.threshold - .01), rolling_mean, 30)[1]

            cutpoints_final = ImageColumnCropOperators.list_clean(image_array, cutpoints_initial, 100, 10, 20)

            cutpoints = self.clean_cutpoints_vertical(image_array, cutpoints_final, 25)
