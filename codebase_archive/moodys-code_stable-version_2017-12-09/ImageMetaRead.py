...
class ImageMetaRead(object):
    ...
    Attributes:
        ...
        number_columns: Number of text columns in the image.
    ...
    def __init__(self, file, cropped_image_full, image_to_columns):

        self.image_column_data = image_to_columns.number_columns
        ...
        self.number_columns = self.set_number_columns()
    ...
    def set_number_columns(self):
        """Define Number Columns value."""

        if self.image_column_data == 'one-column/':
            number_columns = 1
        elif self.image_column_data == 'two-column/':
            number_columns = 2
        elif self.image_column_data == 'three-column/':
            number_columns = 3
