...
class ImageOperator(object):
    ...
    def __init__(self, file):
        ...
        self.horizontal_gutter_test = ImageColumnCropper.ImageColumnCropper(self.rotated_image,
                                                                            self.cropped_image_full,
                                                                            'horizontal')

        self.image_to_columns = ImageColumnCropper.ImageColumnCropper(self.rotated_image,
